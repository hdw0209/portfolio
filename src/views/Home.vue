                ...
                <v-card class="mx-auto rounded-xl pa-5 card-list">
                    <div class="d-flex justify-space-between align-center mb-4">
                        ...
                        <div>
                            ...
                            <v-btn fab :small="$vuetify.breakpoint.smAndUp" elevation="0" @click="openWindow(work.link)" v-if="work.link" class="ml-1">
        ...
        works: [
            {
                ...
                img: 'design_2020_08',
                types: ['PUBLISING', 'DESIGN', '반응형', 'materializecss'],
            ...
            },
            {
                ...
                title: '지하매설물 관리 시스템',
                img: 'bauger_01',
                types: ['PUBLISING', 'DESIGN', '반응형', 'vue', 'vuetify'],
                details: [
                    {
                        id: 1,
            ...
            },
            {
                ...
                title: '운동타이머',
                img: 'healthtimer',
                types: ['PUBLISING', 'DESIGN', 'vue', 'QUASAR'],
            ...
            },
            {
                ...
                title: '대전문화재단 생활문화포털',
                img: 'culture_01',
                types: ['PUBLISING', 'DESIGN', '반응형', 'vue', 'QUASAR'],
            ...
            },
            {
                ...
                img: 'hcp_01',
                types: ['PUBLISING', 'DESIGN', '반응형', 'materializecss'],
                link: 'https://ncv.kdca.go.kr/hcp/',
                details: [
                    {
                        id: 1,
                        images: ['hcp_01', 'hcp_02'],
                        title: '질병관리청 보건의료인용 ',
                    },
                ],
            },
